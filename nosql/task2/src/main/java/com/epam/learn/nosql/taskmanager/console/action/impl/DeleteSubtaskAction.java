...
@Service
public class DeleteSubtaskAction extends AbstractTaskConsoleAction {

    private static final String DEFAULT_DESCRIPTION = "Delete subtask task";
    private static final String DEFAULT_CATEGORY_MESSAGE = "Put json next";

    private final String categoryMessage;
    private final ObjectMapper objectMapper;

    public DeleteSubtaskAction(InputCatcher inputCatcher, OutputPitcher outputPitcher, TaskService taskService, ObjectMapper objectMapper, String categoryMessage) {
    ...
    @Autowired
    public DeleteSubtaskAction(InputCatcher inputCatcher, OutputPitcher outputPitcher, TaskService taskService, ObjectMapper objectMapper) {
    ...
    public boolean act() {
        ...
        try {
            ...
            final List<Subtask> subtasks = taskService.deleteSubtasks(task);
